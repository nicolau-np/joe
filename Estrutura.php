...
<body id="subpage">
    ...
    <div>
        <div class="es">
            <CENTER>
                <H2>
                    <font color="black">ESTRUTURA DA ESCOLA</font>
                </H2>
            </CENTER>
            <P>
            <h4>
                <font color="white">
                    <BR> 12 Sala de aula;</BR>
                    <BR>1 Cantina escolar;</BR>
                    <BR> 12 Casa de banho; </BR>
                    <BR>1 Sala dos professores,</BR>
                    <BR>2 Secretaria;</BR>
                    <BR>1 Gabinete psicopedagógico;</BR>
                    <BR>1 Sala de infórmatica;</BR>
                </font>
            </h4>
            </P>
        </div>
