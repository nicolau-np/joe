...
<body id="home">
    ...
    <div id="templatemo_main">
        <B>
            <center>
                <h2>Caracterização da Escola</h2>
            </center>
        </B>
        A Escola de Formação de Professores do Magistério Primário Nº 78N Júlia Lopes do Namibe,é uma instituição de
        Ensino Secundário do II Ciclo, criada à luz do Decreto executivo nº63/015 de 03 de Março, no âmbito da reforma
        educativa e do plano mestre com finalidade de formar futuros professores profissionalmente preparados para a
        docência no ensino primário e do pré-escolar.
        <p>
        ...
        Elevar o nível académico e profissional dos agentes da educação nos demais municípios e comunas, sem os retirar
