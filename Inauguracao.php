...
<head>
    ...
    <title>Fotos de inagoração</title>
...
<body id="subpage">
    ...
    <div class="portfolio-group col-md-12 margin-top-30 no-padding">
        <div class="row">
            <!-- Portfolio Item -->
            <div class="portfolio-item col-md-6 video">
                        ...
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <span> Estas fotos estão relacionado com a inagoracão da escola onde faz presente as
                                    figuras Governamentais, Direcção da escola e os alunos em gerais.
                                </span>
                            </figcaption>
                        </figure>
                    </a>
            ...
            <!-- End Portfolio Item -->
            <!-- Portfolio Item -->
            <div class="portfolio-item col-md-6 design">
                <div class="image-hover">
                    <a href="#">
                        <figure>
